    ...
    public function run(): void
    {
        $documentTypes = [
            [
                ...
                'allowed_extensions' => ['pdf', 'jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp'],
                'max_file_size_mb' => 5,
                'is_mandatory' => true,
                'is_active' => true,
            ],
            ...
            [
                ...
                'allowed_extensions' => ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt', 'rtf', 'odt', 'ods', 'odp'],
                'max_file_size_mb' => 10,
                'is_mandatory' => true,
                'is_active' => true,
            ],
            ...
            [
                'name' => 'Dokumen Umum',
                'code' => 'general',
                'description' => 'Dokumen umum lainnya (semua format file didukung)',
                'requires_expiry' => false,
                'default_validity_months' => null,
                'allowed_extensions' => [
