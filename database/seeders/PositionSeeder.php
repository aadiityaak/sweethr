...
class PositionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $positions = [
            ...
            // Warung Mas Mbull — jabatan outlet sesuai PDF
            [
                'title' => 'Cleaner',
                'code' => 'CLN001',
                'description' => 'SOP Sanitasi & Kebersihan Outlet, bahan kimia, sampah & area makan',
                'department_id' => $departments['OUTLET']->id,
                'level' => 1,
                'base_salary' => 3200000,
                'permissions' => [],
                'is_active' => true,
            ...
            [
                'title' => 'Pramusaji',
                'code' => 'PRM001',
                'description' => 'Customer Service Excellence, product knowledge, complaint handling, upselling',
                'department_id' => $departments['OUTLET']->id,
                'level' => 1,
                'base_salary' => 3400000,
                'permissions' => [],
            ...
            [
                'title' => 'Kasir',
                'code' => 'KSR001',
                'description' => 'SOP Kasir & POS, pembayaran, rekap kas harian, anti selisih & fraud',
                'department_id' => $departments['OUTLET']->id,
                'level' => 2,
                'base_salary' => 3600000,
            ...
            [
                'title' => 'Koki',
                'code' => 'KOK001',
                'description' => 'Standard Recipe, Food Safety & FIFO, manajemen dapur & waste',
                'department_id' => $departments['OUTLET']->id,
                'level' => 2,
                'base_salary' => 3800000,
                'permissions' => [],
            ...
            [
                'title' => 'Ast SPV (Asisten Supervisor)',
                'code' => 'ASP001',
                'description' => 'Pengawasan harian & briefing, stok opname, supervisory & troubleshooting',
                'department_id' => $departments['OUTLET']->id,
                'level' => 3,
                'base_salary' => 5000000,
                'permissions' => ['manage_outlet', 'supervise_team'],
                'is_active' => true,
            ],
            [
                'title' => 'SPV Outlet',
                'code' => 'SPV001',
                'description' => 'Manajemen outlet, food cost & waste, SDM/KPI/PIP, P&L & audit total',
                'department_id' => $departments['OUTLET']->id,
                'level' => 4,
                'base_salary' => 6500000,
                'permissions' => ['manage_outlet', 'manage_team', 'view_reports'],
                'is_active' => true,
            ],
        ];
