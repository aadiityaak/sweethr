...
<template>
    <AuthBase title="Masuk ke Akun Anda" description="Silakan masukkan email dan password untuk melanjutkan">
        ...
        <div v-if="status" class="mb-6 rounded-lg border border-green-200 bg-green-50 p-4 text-center text-sm font-medium text-green-800 dark:border-green-800 dark:bg-green-900/20 dark:text-green-300">
            {{ status }}
        </div>
