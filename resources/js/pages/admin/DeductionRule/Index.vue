        ...
        <div class="mx-auto w-full px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <!-- Hover effect overlay -->
                    <div
                        class="pointer-events-none absolute inset-0 rounded-xl bg-gradient-to-br from-orange-500/5 to-amber-500/5 opacity-0 transition-opacity group-hover:opacity-100"
                    ></div>
                </div>
