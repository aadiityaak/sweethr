        ...
        <div class="mx-auto w-full px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <div
                        class="absolute inset-0 rounded-xl bg-gradient-to-br from-red-500/5 to-rose-500/5 opacity-0 transition-opacity group-hover:opacity-100 pointer-events-none
                    ></div>
                </div>
                ...
                >
                    ...
                    <!-- Hover effect overlay -->
                    <div
                        class="absolute inset-0 rounded-xl bg-gradient-to-br from-orange-500/5 to-amber-500/5 opacity-0 transition-opacity group-hover:opacity-100 pointer-events-none
                    ></div>
                </div>
