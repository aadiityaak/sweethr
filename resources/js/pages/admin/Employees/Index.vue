    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-full px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Kelola informasi dan peran karyawan</p>
                    </div>
            ...
            <div class="mb-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-1 text-3xl font-bold text-gray-900 dark:text-white">{{ totalEmployees || 0 }}</p>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">{{ departments.length }} departemen</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-1 text-3xl font-bold text-gray-900 dark:text-white">{{ activeEmployees || 0 }}</p>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">{{ activePercentage }}% dari total</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-1 text-3xl font-bold text-gray-900 dark:text-white">{{ inactiveEmployees || 0 }}</p>
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-500">{{ inactivePercentage }}% dari total</p>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 p-6 text-white shadow-lg">
                    ...
                    <div class="mt-4">
                        <p class="text-sm font-medium text-blue-100">Total Departemen</p>
                        <p class="mt-1 text-3xl font-bold text-white">{{ departments.length || 0 }}</p>
                        <p class="mt-1 text-xs text-blue-100">{{ positions.length }} posisi tersedia</p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-gray-900 dark:ring-white/10">
                ...
                <!-- Pagination -->
                <div v-if="employees?.meta?.total > employees?.meta?.per_page" class="border-t border-gray-200 px-6 py-4 dark:border-gray-700">
                    <div class="flex items-center justify-between">
