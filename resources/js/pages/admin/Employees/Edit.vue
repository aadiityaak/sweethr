                                        ...
                                        <div class="grid gap-3 sm:grid-cols-2">
                                            ...
                                            >
                                                ...
                                                <span>
                                                    ...
                                                    <p class="mt-0.5 text-xs text-muted-foreground">Kontrak berjangka, terikat tanggal akhir (sinkron ke modul Kontrak).</p>
                                                </span>
                                            </label>
                                            <label
                                                class="flex cursor-pointer items-start gap-3 rounded-lg border p-3"
                                            ...
                                            >
                                                ...
                                                <span>
                                                    ...
                                                    <p class="mt-0.5 text-xs text-muted-foreground">Tanpa batas waktu, end_date = null di Kontrak.</p>
                                                </span>
                                            </label>
                                        </div>
