    ...
    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Edit Shift Kerja</h1>
                    <p class="text-muted-foreground">Edit informasi shift "{{ workShift.name }}"</p>
                </div>
                <Link
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6">
                    ...
                    <div v-if="workShift.employee_shifts_count > 0" class="rounded-lg border bg-yellow-50 p-4 dark:bg-yellow-950/20">
                        <h4 class="font-medium text-yellow-900 dark:text-yellow-400 mb-2">
                            <AlertTriangle class="h-4 w-4 inline mr-1" />
                            Peringatan
                        </h4>
                        <p class="text-sm text-yellow-700 dark:text-yellow-300">
                            Shift ini memiliki {{ workShift.employee_shifts_count }} penugasan aktif.
                            Perubahan akan mempengaruhi jadwal karyawan yang sudah ditugaskan.
                        </p>
                    </div>
                </div>
            </div>
