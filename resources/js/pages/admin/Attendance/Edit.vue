        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Koreksi data kehadiran karyawan
                    </p>
                </div>
            </div>
            ...
            <div class="rounded-xl border border-gray-200/50 bg-white p-6 shadow-sm dark:border-gray-800/50 dark:bg-gray-950">
                <div class="flex items-center gap-4">
                    <div class="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-lg font-semibold text-blue-700 dark:bg-blue-950/50 dark:text-blue-400">
            ...
            <div class="rounded-xl border border-gray-200/50 bg-white shadow-sm dark:border-gray-800/50 dark:bg-gray-950">
                <div class="border-b border-gray-200/50 p-6 dark:border-gray-800/50">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Edit informasi kehadiran karyawan
                    </p>
                </div>
                ...
                <div class="p-6">
                    ...
                    >
                        ...
                        <!-- Form Actions -->
                        <div class="flex items-center gap-3 pt-6 border-t border-gray-200/50 dark:border-gray-800/50">
                            <button
                                type="submit"
                                :disabled="processing"
                                class="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
