...
import { Calendar, Clock, Plus, Eye, Trash2, AlertCircle, CheckCircle, XCircle, ArrowLeft, RefreshCw } from 'lucide-vue-next';
import { ref } from 'vue';
            ...
            <div class="px-4 py-6 pb-24">
                ...
                <div class="mb-6 grid gap-3 grid-cols-2">
                    <div class="rounded-lg border bg-card p-4 text-center">
                        ...
                        <p class="text-xs text-muted-foreground font-medium">Request Bulan Ini</p>
                    </div>
                ...
                <div class="rounded-lg border bg-card">
                        ...
                        >
                            ...
                            <div v-if="request.status === 'pending'" class="mt-3 flex gap-2">
                                <Link :href="`/shift-change-requests/${request.id}`" class="flex-1">
                                    <div class="w-full rounded-md bg-secondary px-3 py-2 text-sm font-medium text-secondary-foreground text-center hover:bg-secondary/80 transition-colors">
                                        Lihat Detail
                                    </div>
                                </Link>
                                <form
                                ...
                                >
                                    <button
                                        ...
                                        class="rounded-md bg-destructive px-3 py-2 text-sm font-medium text-destructive-foreground hover:bg-destructive/90 transition-colors"
                                    >
                                        Batalkan
                                    </button>
                                </form>
                    ...
                    <!-- Pagination -->
                    <div v-if="requests.meta?.total > requests.meta?.per_page" class="p-4 border-t">
