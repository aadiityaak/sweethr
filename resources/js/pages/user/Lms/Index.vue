...
import { ArrowLeft, BookOpen, ClipboardList, FileText, HelpCircle } from 'lucide-vue-next';
        ...
        <div class="mx-auto min-h-screen max-w-[480px] bg-background">
            ...
            <div class="px-4 py-6 pb-24">
                <div class="mb-6 grid grid-cols-3 gap-3">
                    <a href="#materi" class="rounded-lg border bg-card p-3 transition-colors hover:bg-muted/50">
                    ...
                    <a href="#kuis" class="rounded-lg border bg-card p-3 transition-colors hover:bg-muted/50">
                    ...
                    <a href="#tugas" class="rounded-lg border bg-card p-3 transition-colors hover:bg-muted/50">
                ...
                <div id="materi" class="rounded-lg border bg-card">
                ...
                <div id="kuis" class="mt-6 rounded-lg border bg-card">
                    <div class="border-b p-4">
                        <h2 class="flex items-center gap-2 text-lg font-semibold">
                    ...
                    <div class="divide-y">
                        <div v-for="quiz in quizzes" :key="quiz.id" class="p-4">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                        ...
                        <div v-if="!quizzes.length" class="p-8 text-center">
                ...
                <div id="tugas" class="mt-6 rounded-lg border bg-card">
                    <div class="border-b p-4">
                        <h2 class="flex items-center gap-2 text-lg font-semibold">
                    ...
                    <div class="divide-y">
                        ...
                        <div v-if="!assignments.length" class="p-8 text-center">
