    ...
    <div class="space-y-4">
        ...
        <div
            ...
            :class="[
                ...
                isDragOver ? 'border-blue-400 bg-blue-50 dark:border-blue-400 dark:bg-blue-950/50' : 'border-gray-300 dark:border-gray-600',
        ...
        >
            <input ref="fileInputRef" type="file" class="hidden" :accept="acceptedFormats" :disabled="disabled" @change="handleFileSelect" />
            ...
            <div class="text-center">
                ...
                <div class="mt-4">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">Maksimal {{ maxSizeMB }}MB</p>
                </div>
            </div>

            <!-- Loading overlay -->
            <div v-if="uploading" class="absolute inset-0 flex items-center justify-center rounded-lg bg-white/80 dark:bg-gray-900/80">
                <div class="text-center">
        ...
        <div v-if="selectedFile" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <button v-if="!disabled" type="button" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" @click="removeFile">
                    <X class="h-5 w-5" />
                </button>
            </div>
        </div>
...
import { CircleAlert, FileText, LoaderCircle, Upload, X } from 'lucide-vue-next';
